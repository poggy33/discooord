  ...
  return (
    <>
      ...
      >
        ...
        <kbd className="pointer-events-none inline-flex h-5 select-none items-centre gap-1 rounde-border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground ml-auto">
